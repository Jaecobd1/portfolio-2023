  ...
  return (
    ...
    >
      ...
      <div className="p-12 relative">
        <div
          className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-slate-900 to-black opacity-50 p-12"
        ...
        >
          ...
          >
            <span>
              ...
              development. Starting in middle school, I dived headfirst into the
        ...
        <div className="text-2xl flex flex-col gap-12  items-center p-6 md:text-slate-500 ">
          <span>
            ...
            Starting in middle school, I dived headfirst into the world of web
